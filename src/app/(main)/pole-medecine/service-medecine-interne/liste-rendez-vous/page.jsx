...
const SMedecineInterneRendezVousPage = () => {
  return (
    <div className="">
      {/* HAUT */}
      <div className="mb-4">
        {/* Titre */}
        <h1 className="text-lg font-semibold mb-2">Calendrier des rendez-vous</h1>
...
export default SMedecineInterneRendezVousPage