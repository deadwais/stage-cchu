  ...
  return (
    <div className="">
      ...
      <div className="flex gap-4 justify-between flex-wrap">
        ...
        <Cards type="Radios" nombre="250100"/>
        <Cards type="Echos" nombre="101446"/>
      </div>
      ...
      <div className="flex gap-4 justify-center items-center mt-4">
        ...
        <div className="flex flex-col gap-3 w-full">
          ...
          <div className="bg-white rounded-2xl w-full p-2">
            {/* TITRE */}
            <div className="">
              <h1 className="text-center text-md font-bold">Examens fréquents</h1>
            </div>
...
export default SImagerieDashboardPage